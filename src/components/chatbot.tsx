      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-50 w-16 h-16 text-white rounded-full shadow-2xl flex items-center justify-center transition-all active:scale-95 ${
          chatOpen
            ...
            : "bg-gradient-to-br from-blue-700 to-blue-800 shadow-blue-300/50 hover:from-blue-800 hover:to-blue-900"
        }`}
          ...
          <>
            ...
            >
              ...
              <motion.button
                ...
                onClick={openChat}
                className="flex items-center gap-3 bg-white border border-blue-200 rounded-2xl px-4 py-3 shadow-xl hover:shadow-2xl hover:bg-blue-50 transition-all active:scale-95 group w-auto"
              >
                <div className="w-11 h-11 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-md shadow-blue-200 group-hover:scale-105 transition-transform">
      ...
      <AnimatePresence>
        {chatOpen && (
          <motion.div
            ...
            transition={{ type: "spring", damping: 25, stiffness: 300 }}
            className="fixed bottom-6 right-6 z-50 w-[calc(100vw-3rem)] sm:w-[400px] max-h-[calc(100vh-6rem)] bg-white rounded-2xl shadow-2xl border border-blue-100 flex flex-col overflow-hidden max-w-[calc(100vw-3rem)]"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-700 to-blue-800 text-white p-4 flex items-center justify-between flex-shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-[300px] max-h-[450px] bg-gray-50/50">
              {messages.map((msg) => (
                ...
                >
                  ...
                  {msg.role === "user" && (
                    <div className="w-7 h-7 bg-blue-700 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {QUICK_QUESTIONS.map((q) => (
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full hover:bg-blue-100 hover:text-blue-800 transition-colors font-medium border border-blue-100"
                    >
                      {q}
                    </button>
                  ))}
            ...
            <div className="p-3 bg-white border-t border-gray-100 flex-shrink-0">
              <div className="flex items-center gap-2">
                <input
                  ...
                  disabled={isLoading}
                  className="flex-1 h-11 px-4 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-100 transition-all disabled:opacity-50 placeholder:text-gray-400"
                />
                <Button
                  onClick={() => sendMessage(input)}
                  disabled={!input.trim() || isLoading}
                  className="h-11 w-11 bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white rounded-xl p-0 flex items-center justify-center flex-shrink-0 disabled:opacity-40 transition-all"
                >

...
const DEFAULTS: SiteSettings = {
  company_name: "ITS Academic",
  total_units_sold: "500",
  company_legal_name: "ITS Academic",
  logo_url: "",
  ...
  contact_phone: "-",
  contact_email: "info@itsacademics.com",
  contact_wa: "",
  contact_address: "Surabaya, Jawa Timur",
  contact_person: "ITS Academic",
  map_latitude: "-7.2816",
  map_longitude: "112.7954",
  social_instagram: "itsacademics",
  social_facebook: "",
  social_youtube: "",
  social_tiktok: "",
};

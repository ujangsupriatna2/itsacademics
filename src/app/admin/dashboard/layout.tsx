    ...
    <div className="flex flex-col h-full bg-gray-900">
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-800">
        {S.logo_url ? (
          ...
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-700 to-blue-800 flex items-center justify-center shrink-0">
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 text-sm">
          <a href="/?tab=home" className="text-gray-400 hover:text-blue-700 transition-colors">
              ...
              <div className="hidden md:block text-left">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  {(session.user as { mitraName?: string | null }).mitraName && (
                    <span className="inline-block px-1.5 py-0.5 text-[10px] font-semibold rounded-md leading-none bg-blue-100 text-blue-700">
                      {(session.user as { mitraName?: string | null }).mitraName}
                    </span>
                  )}
                </div>

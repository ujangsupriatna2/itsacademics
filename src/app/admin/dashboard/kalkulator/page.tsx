...
function KPRCalculator() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-0 shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-4 p-3 bg-blue-50 rounded-lg">
            <span className="text-xs font-medium text-blue-800">Tipe Bunga:</span>
            ...
            <div className="flex items-start gap-1 ml-auto">
              <Info className="w-3.5 h-3.5 text-blue-300 mt-0.5 shrink-0" />
      ...
      {/* Result Card */}
      <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-700 via-blue-800 to-rose-800 text-white">
        <CardContent className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="text-blue-200 text-sm font-medium">Cicilan per Bulan</p>
            ...
            <div className="flex gap-1">
              <Button
                ...
                className="text-blue-200 hover:text-white hover:bg-blue-600/30"
                title="Lihat Detail"
              >
              ...
              <tbody>
                ...
                <tr className="border-t border-gray-100 bg-gray-50/50">
                  ...
                  {[5, 10, 15, 20, 25].map((t) => {
                    ...
                    return (
                      <td key={t} className="px-4 py-2.5 text-center text-xs text-blue-600">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs px-2 py-0.5 bg-blue-100 text-blue-800 rounded-full font-medium">{rateType === "flat" ? "Flat" : "Anuitas"}</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {/* Highlight */}
              <div className="text-center mb-6 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-sm text-blue-700 font-medium">Cicilan Per Bulan</p>
                <p className="text-3xl font-extrabold text-blue-800 mt-1">Rp {formatRupiah(result.monthly)}</p>
                <p className="text-xs text-blue-600 mt-1">{rateType === "flat" ? "Bunga Flat — tetap setiap bulan" : "Bunga Anuitas — tetap, porsi pokok meningkat"}</p>
              </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t border-gray-100 bg-blue-50">
                      <td className="px-4 py-3 text-blue-800 font-semibold">Total Pembayaran</td>
                      <td className="px-4 py-3 text-right font-bold text-blue-800">Rp {formatRupiah(result.totalPayment)}</td>
                    </tr>
                    <tr className="border-t border-gray-100 bg-blue-50/50">
                      <td className="px-4 py-3 text-blue-700 font-medium">Total Bunga</td>
                      <td className="px-4 py-3 text-right font-semibold text-blue-700">Rp {formatRupiah(result.totalInterest)}</td>
                    </tr>
                  </tbody>
                </table>
              </div>

  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-slate-50 p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <a
          href="/?tab=home"
          className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-blue-700 transition-colors mb-8"
        >
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center pb-2">
            <div className="mx-auto w-14 h-14 bg-gradient-to-br from-blue-700 to-blue-800 rounded-2xl flex items-center justify-center mb-4">
          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white font-semibold"
              >
                {loading ? (

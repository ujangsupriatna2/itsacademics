          ...
          <nav className="hidden md:flex items-center gap-1">
            {NAV_LINKS.map((link) => {
              ...
              const activeClass = isSolid
                ...
                : "text-white font-semibold underline underline-offset-4 decoration-blue-400 decoration-2";
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-3 font-medium rounded-xl transition-colors active:bg-blue-100 text-left ${
                      isActive
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        <div className="max-w-2xl">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Badge className="mb-6 bg-blue-500/20 text-blue-300 border-blue-500/30 backdrop-blur-sm px-4 py-1.5 text-sm font-medium">
              <Sparkles className="w-3.5 h-3.5 mr-1.5" />
              Perumahan Modern &amp; Berkualitas
            </Badge>
          </motion.div>
          ...
          >
            Hunian Nyaman,{" "}
            <span className="text-gradient-navy">Cicilan</span> Ringan
            <br />
            <span className="text-blue-300">Syariah &amp; KPR</span>
          </motion.h1>
          ...
          >
            ...
            <span className="text-blue-300 font-semibold">Syariah &amp; KPR Bank</span>.
            Cicilan mulai{" "}
            <span className="text-blue-300 font-semibold">Rp 999k/bulan</span>.
          ...
          >
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-700 to-blue-800 text-white font-bold rounded-2xl shadow-2xl shadow-blue-950/50 hover:from-blue-800 hover:to-blue-900 hover:shadow-blue-950/70 transition-all active:scale-95 text-lg"
            >
              Lihat Properti
...
function PromoStrip() {
  ...
  return (
    <div className={`bg-gradient-to-r from-blue-800 via-blue-700 to-blue-800 transition-all duration-300 ${dismissed ? "h-0 overflow-hidden" : ""}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 text-white text-sm flex-1 min-w-0">
          <Badge className="bg-blue-500 text-white border-0 text-xs font-bold px-2.5 py-0.5 shrink-0">
            🔥 Promo Terbatas
          </Badge>
          ...
          <a
            ...
            className="text-blue-200 font-semibold hover:text-blue-100 transition-colors whitespace-nowrap ml-auto"
          >
            Tanya Sekarang →
          </a>
        </div>
...
function FeaturesSection() {
  const { settings: S } = useSettingsStore();
  return (
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Mengapa Memilih{" "}
            <span className="text-blue-700">{S.company_name}</span>?
          </h2>
            ...
            <FadeIn key={feat.title} delay={i * 0.1}>
              <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <CardContent className="p-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mb-5 shadow-lg shadow-blue-200 group-hover:shadow-blue-300 transition-shadow">
...
function TentangKamiKeunggulanSection() {
  ...
  return (
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          <Badge variant="secondary" className="mb-4 bg-blue-50 text-blue-800 border-blue-200">
            <Award className="w-3.5 h-3.5 mr-1.5" />
            Keunggulan Kami
          </Badge>
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Mengapa <span className="text-blue-700">Berpercaya</span> pada Kami?
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
      ...
      <Card className="group h-full overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 cursor-pointer" onClick={() => onSelect(property)}>
        <div className="relative h-40 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex gap-1.5">
            <Badge className="bg-blue-700 text-white border-0 shadow-lg text-xs">
              {property.tag}
            </Badge>
          </div>
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-lg font-extrabold text-blue-700">Rp {property.price}</span>
    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Pilih Proyek <span className="text-blue-700">Idaman</span> Anda
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
        ...
        <FadeIn delay={0.1} className="flex justify-center mb-10">
          <Select value={activeCategory} onValueChange={(v) => setActiveCategory(v as PropertyCategory | "all")}>
            <SelectTrigger className="w-[180px] h-10 text-xs font-semibold border-gray-200 focus:ring-blue-600 focus:border-blue-600">
        ...
        <FadeIn className="text-center mt-10">
          <button
            onClick={() => router.push("/?tab=proyek")}
            className="inline-flex items-center gap-2 px-6 py-3 bg-blue-50 text-blue-800 font-semibold rounded-xl hover:bg-blue-100 transition-colors"
          >
            Lihat Semua Proyek
...
function CaraBeliSection() {
  ...
  const steps = [
    ...
    { num: 2, title: "Pilih Proyek", desc: "Pilih proyek yang sesuai kebutuhan dan budget Anda dari pilihan Siap Huni, Kavling, atau Inden.", icon: Home, gradient: "from-blue-600 to-blue-700" },
    { num: 3, title: "Hitung Cicilan", desc: "Gunakan kalkulator simulasi cicilan kami untuk menentukan DP dan tenor yang tepat.", icon: Calculator, gradient: "from-cyan-500 to-cyan-600" },
    ...
    <section className="py-20 md:py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Proses <span className="text-blue-700">Mudah</span> & Transparan
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[calc(12.5%+24px)] right-[calc(12.5%+24px)] h-0.5 bg-gradient-to-r from-green-300 via-blue-300 to-purple-300 z-0" />
        ...
        <FadeIn className="flex flex-col sm:flex-row gap-4 justify-center mt-14">
          ...
          <a
            href="/?tab=proyek"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-700 text-white font-bold rounded-2xl shadow-lg hover:bg-blue-800 transition-all active:scale-95 text-lg"
          >
            <Calculator className="w-5 h-5" />
            Hitung Cicilan Saya
          </a>
    ...
    <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-shadow bg-white">
      <CardContent className="p-6">
        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
            {t.name.charAt(0)}
          </div>
...
function TestimonialsSection({ limit }: { limit?: number }) {
      ...
      <section className="py-20 md:py-28 bg-cool-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
              Apa Kata <span className="text-blue-700">Penghuni</span> Kami?
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
  ...
  return (
    <section className="py-20 md:py-28 bg-cool-bg overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          <Badge
            variant="secondary"
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top fade */}
        <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-cool-bg to-transparent z-10 pointer-events-none" />
        {/* Bottom fade */}
        <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-b from-transparent to-cool-bg z-10 pointer-events-none" />
    ...
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Pertanyaan <span className="text-blue-700">Umum</span>
          </h2>
        ...
        <FadeIn>
          <Accordion type="single" collapsible className="space-y-3">
            {FAQ_ITEMS.map((item, i) => (
              ...
              >
                <AccordionTrigger className="text-base font-semibold text-gray-900 hover:text-blue-800 hover:no-underline py-5">
                  {item.q}
                </AccordionTrigger>
    ...
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Galeri <span className="text-blue-700">Foto</span>
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
...
function CTASection() {
  const { settings: S } = useSettingsStore();
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-blue-800 via-blue-700 to-blue-900 relative overflow-hidden">
    ...
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Informasi <span className="text-blue-700">Terbaru</span>
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
    ...
    <FadeIn className="h-full">
      <Card className="group h-full overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="relative h-52 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex gap-1.5">
            {property.tag && (
              <Badge className="bg-blue-700 text-white border-0 shadow-lg text-[10px] px-2">
                {property.tag}
              </Badge>
            )}
        ...
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-1">
            <Badge variant="secondary" className="bg-blue-50 text-blue-800 text-xs font-semibold">
              {CATEGORY_LABELS[property.category as PropertyCategory] || property.category}
            </Badge>
          ...
          <h3 className="font-bold text-base text-gray-900 mb-1 group-hover:text-blue-800 transition-colors line-clamp-1">
            {property.name}
          </h3>
            ...
            return (
              <div className="flex flex-wrap gap-1.5 mb-3">
                {featList.slice(0, 4).map((f) => (
                  <span key={f} className="text-[11px] px-2 py-0.5 bg-blue-50 text-blue-700 rounded-md border border-blue-200">
                    {f}
                  </span>
                ))}
                {featList.length > 4 && (
          ...
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => onSelect(property)} size="sm" className="bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white shadow-md shadow-blue-200">
  ...
  return (
    <div className="flex items-center justify-center gap-1.5 mt-10">
      <button
        ...
        className="w-9 h-9 flex items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:bg-blue-50 hover:text-blue-800 hover:border-blue-200 transition-all disabled:opacity-30 disabled:pointer-events-none"
      >
          ...
          <button
            ...
            className={`w-9 h-9 flex items-center justify-center rounded-lg text-sm font-semibold transition-all ${
              currentPage === p
                ...
                : "border border-gray-200 text-gray-600 hover:bg-blue-50 hover:text-blue-800 hover:border-blue-200"
            }`}
          >
            {p}
          </button>
    ...
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Pilih Rumah <span className="text-blue-700">Idaman</span> Anda
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
        ...
        <FadeIn delay={0.1} className="flex justify-center gap-3 mb-10">
          <Select value={activeCategory} onValueChange={(v) => setActiveCategory(v as PropertyCategory | "all")}>
            <SelectTrigger className="w-[160px] h-10 text-xs font-semibold border-gray-200 focus:ring-blue-600 focus:border-blue-600">
              <SelectValue placeholder="Semua Kategori" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">Semua Kategori</SelectItem>
    ...
    <>
      ...
      >
        ...
        <div className="absolute bottom-4 left-6 right-6">
          <Badge className="bg-blue-700 text-white border-0 mb-2">
            {tag}
          </Badge>
          ...
          {images.map((img, idx) => (
            <button
              ...
              className={`flex-shrink-0 w-20 h-14 rounded-lg overflow-hidden border-2 transition-all cursor-pointer ${
                activeImg === idx
                  ? "border-blue-700 shadow-md shadow-blue-200"
        ...
        <div className="p-6">
          ...
          <div className="flex items-start gap-2 mb-4">
            ...
            <div className="flex flex-col gap-1.5">
              <Badge variant="secondary" className="bg-blue-50 text-blue-800 text-xs font-semibold w-fit">
                {CATEGORY_LABELS[property.category as PropertyCategory] || property.category}
              </Badge>
          ...
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div className="bg-blue-50 rounded-xl p-4 text-center">
              <p className="text-xs text-blue-600 uppercase tracking-wider mb-1">Harga Rumah</p>
              <p className="text-xl font-extrabold text-blue-800">Rp {formatRp(property.price * 1_000_000)}</p>
              <p className="text-[11px] text-blue-300 mt-0.5">({property.price} Juta)</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-4 text-center">
              <p className="text-xs text-blue-600 uppercase tracking-wider mb-1">Tipe Bangunan</p>
              <p className="text-xl font-extrabold text-blue-800">{property.type}</p>
              <p className="text-[11px] text-blue-400 mt-0.5">LB {property.buildingArea} m² / LT {property.landArea} m²</p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-700 text-white font-semibold rounded-xl hover:bg-blue-800 transition-colors"
            >
...
function CalculatorSection() {
  ...
  return (
    <section id="simulasi" className="py-20 md:py-28 bg-cool-bg relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-blue-100/50 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Hitung <span className="text-blue-700">Cicilan</span> Anda
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
            ...
            {(["syariah", "kpr"] as const).map((type) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 ${
                  finType === type
                    ? "bg-gradient-to-r from-blue-700 to-blue-800 text-white shadow-lg shadow-blue-200"
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto items-start">
          <FadeIn direction="left" className="min-w-0 overflow-hidden">
            <Card className="border-0 shadow-xl min-w-0 overflow-hidden">
              <CardContent className="p-5 md:p-8 space-y-6">
                  ...
                  <div className="flex justify-between text-xs text-gray-400 mt-1">
                    {dpOptions.map((opt) => (
                      <button
                        ...
                        className={`${dpNum === opt ? "text-blue-700 font-bold" : "hover:text-gray-600"} transition-colors`}
                      >
                        {opt}%
                      </button>
                    ))}
                ...
                <div className={`rounded-xl p-4 border ${effectiveFinType === "syariah" ? "bg-cyan-50 border-cyan-200" : "bg-blue-50 border-blue-200"}`}>
                  <p className={`text-xs flex items-center gap-1.5 ${effectiveFinType === "syariah" ? "text-cyan-700" : "text-blue-700"}`}>
                    {effectiveFinType === "syariah"
          ...
          <FadeIn direction="right" className="min-w-0 overflow-hidden">
            <Card className="border-0 shadow-xl text-white bg-gradient-to-br from-blue-700 to-blue-800 min-w-0 overflow-hidden">
              <CardContent className="p-5 md:p-8">
                <div className="text-center mb-8">
                  ...
                  <Badge className="mt-3 bg-blue-500/20 text-blue-300 border-blue-500/30 text-xs">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={row.label} className="flex justify-between items-center gap-2 min-w-0">
                      <span className="text-blue-200 text-sm shrink-0">{row.label}</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full px-6 py-4 bg-white text-blue-800 font-bold rounded-xl hover:bg-blue-50 transition-colors shadow-lg text-lg"
                >
                  <MessageCircle className="w-5 h-5" />
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className={`text-white ${effectiveFinType === "syariah" ? "bg-gradient-to-r from-cyan-500 to-cyan-600" : "bg-gradient-to-r from-blue-700 to-blue-800"}`}>
                    ...
                    <tbody>
                      {dpOptions.map((dpVal, idx) => (
                        <tr
                          key={dpVal}
                          className={`${idx % 2 === 0 ? "bg-white" : effectiveFinType === "syariah" ? "bg-cyan-50/50" : "bg-blue-50/50"} ${
                            dpVal === dpNum ? "ring-2 ring-inset " + (effectiveFinType === "syariah" ? "ring-cyan-500" : "ring-blue-600") : ""
                          }`}
                        >
                            ...
                            return (
                              <td
                                ...
                                className={`px-4 py-3 text-center ${
                                  isActive
                                    ? effectiveFinType === "syariah"
                                      ? "bg-cyan-200 font-extrabold text-cyan-800"
                                      : "bg-cyan-100 font-extrabold text-blue-800"
                                    : "text-gray-600"
                                }`}
                              >
                                {val > 0
                ...
                <div className="mt-4 flex items-center gap-2 text-xs text-gray-400">
                  <div className={`w-3 h-3 rounded border ${effectiveFinType === "syariah" ? "bg-cyan-200 border-cyan-300" : "bg-cyan-100 border-cyan-300"}`} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeIn direction="right">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
              Berlokasi di <span className="text-blue-700">Jantung Bandung</span>
            </h2>
    ...
    <section className="py-20 md:py-28 bg-cool-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Kami Siap <span className="text-blue-700">Membantu</span> Anda
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <FadeIn delay={0.1} className="lg:col-span-2 flex flex-col gap-4">
            ...
            >
              ...
              <div>
                <p className="text-xs text-blue-700 font-semibold uppercase tracking-wider">Telepon</p>
                <p className="font-bold text-gray-900">{S.contact_phone}</p>
            ...
            <div className="flex items-center gap-4 p-5 bg-blue-50 border border-blue-200 rounded-2xl">
              ...
              <div>
                <p className="text-xs text-blue-600 font-semibold uppercase tracking-wider">Alamat</p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-md shadow-blue-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label className="text-sm font-semibold text-gray-700 mb-2 block">
                        Nomor WhatsApp <span className="text-blue-600">*</span>
                      </Label>
                      <div className="relative">
      ...
      <section className="py-20 md:py-28 bg-cool-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
              Dokumentasi <span className="text-blue-700">Proyek</span> Kami
            </h2>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeIn direction="right">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
                Developer Perumahan <span className="text-blue-700">Terpercaya</span> di Bandung
              </h2>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <FadeIn>
              <div className="bg-gradient-to-br from-blue-700 to-blue-800 rounded-2xl p-8 text-white h-full">
                <Award className="w-10 h-10 text-blue-200 mb-4" />
            ...
            <FadeIn delay={0.15}>
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 text-white h-full">
                <BookOpen className="w-10 h-10 text-blue-200 mb-4" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
              Track Record <span className="text-blue-200">Kami</span>
            </h2>
          </FadeIn>
            ...
            {[
              ...
              <FadeIn key={stat.label} delay={i * 0.1}>
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  <p className="text-3xl md:text-4xl font-extrabold text-blue-200">{stat.value}</p>
              ...
              {[
                ...
                <div key={item.year} className="flex gap-6">
                  <div className="flex flex-col items-center">
                    <div className="w-12 h-12 bg-blue-400 rounded-full flex items-center justify-center text-blue-900 font-extrabold text-sm shrink-0">
                      {item.year}
                    </div>
      ...
      <section className="py-20 md:py-28 bg-cool-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
              Dokumen <span className="text-blue-700">Lengkap & Aman</span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
      ...
      <section className="py-16 md:py-20 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
              Didukung <span className="text-blue-700">Bank & Lembaga Keuangan</span> Terpercaya
            </h2>
          </FadeIn>
          {bankLoading ? (
              ...
              <div className="relative">
                ...
                >
                  {[...bankItems, ...bankItems].map((bank, i) => (
                    <div
                      key={`${bank.id}-${i}`}
                      className="flex flex-col items-center justify-center w-28 h-20 shrink-0 bg-gray-50 rounded-xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all"
                    >
                      {bank.image ? (
                        <img
                          src={bank.image}
  ...
  if (!article) {
    return (
      <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-cool-bg">
          <div className="w-10 h-10 border-4 border-blue-200 border-t-blue-700 rounded-full animate-spin mb-4" />
    ...
    <>
      ...
      <div className="relative h-72 md:h-96 overflow-hidden">
        {coverImg ? (
          ...
          <div className="h-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center">
      ...
      <article className="py-10 md:py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-visible">
          ...
          {/* Excerpt */}
          {article.excerpt && (
            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-10 border-l-4 border-blue-600 pl-5 italic">
              {article.excerpt}
            </p>
          )}
          ...
          {/* Rich HTML content */}
          <div
            className="prose prose-sm md:prose-base max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-blue-700 prose-img:rounded-xl prose-blockquote:border-l-blue-600 prose-blockquote:text-gray-500 prose-blockquote:italic prose-li:text-gray-700
      ...
      {otherArticles.length > 0 && (
        <section className="py-12 md:py-16 bg-cool-bg">
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-4">
                      ...
                      <h3 className="font-bold text-gray-900 text-sm group-hover:text-blue-800 transition-colors line-clamp-2 leading-snug">
                        {a.title}
                      </h3>
                    </CardContent>
                  </Card>
...
function BlogPage() {
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-cool-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {articles.length === 0 ? (
                ...
                <FadeIn>
                  <Card onClick={() => router.push(`/?tab=blog/${featuredArticle.slug}`)} className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group cursor-pointer mb-8">
                    <div className="h-64 md:h-72 overflow-hidden relative">
                      ...
                      <Badge className="absolute top-4 right-4 bg-blue-400 text-white border-0 text-xs font-bold px-2.5 py-1 z-10">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 z-10">
                        ...
                        <h2 className="text-xl md:text-3xl font-extrabold text-white mb-3 group-hover:text-blue-200 transition-colors leading-tight drop-shadow-lg">
                    ...
                    <FadeIn key={`${article.id}-${page}`} delay={i * 0.05}>
                      <Card onClick={() => router.push(`/?tab=blog/${article.slug}`)} className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden group cursor-pointer">
                        ...
                        <CardContent className="p-5">
                          ...
                          <h3 className="font-bold text-gray-900 mb-2 group-hover:text-blue-800 transition-colors line-clamp-2 leading-snug">
                            {article.title}
                          </h3>
                          <p className="text-sm text-gray-500 leading-relaxed line-clamp-2">
                            {article.excerpt}
                        ...
                        return (
                          ...
                          >
                            <div className="relative shrink-0">
                              ...
                              <div className="absolute -top-1.5 -left-1.5 w-5 h-5 bg-blue-700 text-white rounded-full flex items-center justify-center text-[10px] font-bold z-10">
                                {idx + 1}
                              </div>
                            </div>
                            <div className="min-w-0 flex-1">
                              <p className="text-sm font-semibold text-gray-800 group-hover:text-blue-800 transition-colors line-clamp-2 leading-snug">
                                {article.title}
                              </p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {categories.map((cat) => {
                        ...
                        return (
                          <span
                            key={cat}
                            className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-200 rounded-lg text-sm text-gray-600 hover:text-blue-800 font-medium transition-colors cursor-default"
                          >
                            {cat}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <Instagram className="w-4 h-4 text-blue-300 mt-0.5 flex-shrink-0" />
